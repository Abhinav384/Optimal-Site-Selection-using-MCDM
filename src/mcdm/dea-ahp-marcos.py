...
final_ranking = pd.DataFrame({
    ...
    'District': districts,
    'MARCOS_Score': marcos_score,
}).sort_values('MARCOS_Score', ascending=False)

final_ranking.to_csv('data/efficient_marcos_ranking.csv', index=False)
